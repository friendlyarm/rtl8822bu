...
)
{
	...
	if (dm->support_ic_type == ODM_RTL8192F) {
		...
		ODM_RT_TRACE(dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("0xc80 = 0x%x 0xc88 = 0x%x 0xab4 = 0x%x 0xe14 = 0x%x\n", regc80, regc88, regab4, rege14));
		ODM_RT_TRACE(dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("0x848 = 0x%x 0x838 = 0x%x 0x86c = 0x%x\n", reg848, reg838, reg86c));
	}
